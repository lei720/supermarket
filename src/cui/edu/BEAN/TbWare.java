...
/**
 * TbWare generated by hbm2java
 */
public class TbWare implements java.io.Serializable {
	...
	public TbWare(int id) {
		this.id = id;
	}

	public TbWare(int id, String wareName, String warBewrite, String spec,
