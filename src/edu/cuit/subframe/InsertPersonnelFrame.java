...
ageTextField.addKeyListener(new KeyAdapter() {			
	public void keyTyped(KeyEvent event) {	//某键按下时调用的方法
		...
		deptComboBox.setBackground(new Color(210, 105, 30));
...
insertutton.addActionListener(new ActionListener() {
	public void actionPerformed(ActionEvent e) {
		...
		panel2.setBackground(new Color(160, 82, 45));
		...
		contactTextField.setBackground(new Color(210, 105, 30));
		...
		officePhoneTextField.setBackground(new Color(210, 105, 30));
		...
		closeButton2.setBackground(new Color(210, 105, 30));
