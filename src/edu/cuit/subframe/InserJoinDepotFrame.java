...
public class InserJoinDepotFrame extends JFrame {
	...
	public InserJoinDepotFrame() {
		...
		wNameTextField.setForeground(new Color(210, 105, 30));
		...
		joinTimeTextField.setForeground(new Color(210, 105, 30));
		...
		insertButton.setForeground(new Color(210, 105, 30));
		...
		closeButton.setForeground(new Color(210, 105, 30));
		...
		oIdcomboBox.setBackground(new Color(210, 105, 30));
		...
		remarkTextArea.setForeground(new Color(210, 105, 30));
		...
		wighttextField.setForeground(new Color(210, 105, 30));
