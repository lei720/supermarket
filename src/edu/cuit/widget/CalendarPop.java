...
public class CalendarPop extends JPanel{
	...
	//	day_1.getLabel().setBackground(new Color(210, 180, 140));
		...
		DayPanel dayPanel = new DayPanel("一");
		...
		DayPanel dayPanel_3 = new DayPanel("四");
		...
		DayPanel dayPanel_4 = new DayPanel("五");
