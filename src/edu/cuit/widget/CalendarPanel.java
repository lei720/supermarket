...
public class CalendarPanel extends JPanel {
    ...
    private Color gridColor = Color.LIGHT_GRAY; // @jve:decl-index=0:
    ...
    private JFormattedTextField getDateField() {
        if (dateField == null) {
            ...
            dateField.setForeground(new Color(160, 82, 45));
    ...
    private JCheckBox getJButton() {
        if (jButton == null) {
            ...
            jButton.setBackground(new Color(160, 82, 45));
            jButton.setForeground(new Color(160, 82, 45));
            jButton.setText("<<");
    ...
    private JCheckBox getJButton1() {
        if (jButton1 == null) {
            ...
            jButton1.setBackground(new Color(160, 82, 45));
            jButton1.setForeground(new Color(160, 82, 45));
            jButton1.setText("<");
    ...
    private JCheckBox getJButton2() {
        if (jButton2 == null) {
            ...
            jButton2.setBackground(new Color(160, 82, 45));
            jButton2.setForeground(new Color(160, 82, 45));
            jButton2.setText(">");
    ...
    private JCheckBox getJButton3() {
        if (jButton3 == null) {
            ...
            jButton3.setBackground(new Color(160, 82, 45));
            jButton3.setForeground(new Color(160, 82, 45));
            jButton3.setText(">>");
    ...
    private JPanel getJPanel1() {
        if (jPanel1 == null) {
            ...
            jPanel1 = new JPanel();
            jPanel1.setForeground(new Color(160, 82, 45));
            jPanel1.setBackground(new Color(160, 82, 45));
           // jPanel1.setForeground(new Color(210, 105, 30));
            jPanel1.setOpaque(false);
            jPanel1.setLayout(gridLayout2);
            JLabel[] week = new JLabel[7];
            week[0] = new JLabel("日");
            week[0].setForeground(Color.white);
            week[1] = new JLabel("一");
            week[1].setForeground(Color.white);
            week[2] = new JLabel("二");
            week[2].setForeground(Color.white);
            week[3] = new JLabel("三");
            week[3].setForeground(Color.white);
            week[4] = new JLabel("四");
            week[4].setForeground(Color.white);
            week[5] = new JLabel("五");
            week[5].setForeground(Color.white);
            week[6] = new JLabel("六");
            week[6].setForeground(Color.white);
            ...
            for (int i = 0; i < 6; i++) {
                for (int j = 0; j < 7; j++) {
                   ...
                   days[i][j].setOpaque(false);
                    ...
                    days[i][j].setBackground(new Color(210, 105, 30));
    ...
    private JPanel getToolBar() {
        if (toolBar == null) {
            ...
            toolBar = new JPanel();
            toolBar.setForeground(new Color(160, 82, 45));
